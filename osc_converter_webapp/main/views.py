...
from osc_converter_webapp.main.forms import OSCConfigForm, OSCDispatcherForm
from osc_converter_webapp.main.osc_service import osc_service
...
def config_edit(request, pk=None):
    ...
    if is_ajax:
        return render(request, 'main/config_form_content.html', {
            'form': form,
            'config': config,
        })

    return render(request, 'main/config_form.html', {
        'form': form,
        'config': config,
    })
...
def dispatchers(request, config_pk):
    ...
    return render(request, 'main/dispatchers.html', {
        'config': config,
...
def dispatcher_edit(request, pk):
    ...
    # For AJAX requests, return partial template
    if is_ajax:
        return render(request, 'main/dispatcher_form_content.html', {
            'form': form,
            'dispatcher': dispatcher,
        })

    return render(request, 'main/dispatcher_form.html', {
        'form': form,
        'dispatcher': dispatcher,
        'show_restart_modal': show_restart_modal,
    })
...
def export_logs(request):
    ...
    from osc_converter_webapp.main.models import OSCConfig
